...
ggplot(state_counts_df, aes(x = State, y = Count)) +
  ...
  labs(title = "Figure1:Number of Cartels Active in Each State", x = "State", y = "Count") +
...
ggplot(data.frame(Degree = degree_distribution), aes(x = Degree)) +
  ...
  labs(title = "Figure2: Degree Distribution of Rivalry Network", x = "Degree", y = "Frequency")
```

```{r}
# Correlation Matrix of Cartel Activities
